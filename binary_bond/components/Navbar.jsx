...
<a href="#home" className="flex items-center gap-3 group no-underline">
  ...
  <div className="flex flex-col justify-center">
    ...
    <span className="text-[9px] font-extrabold uppercase tracking-widest text-brand-blue mt-1 leading-none">
      ...
      {/* Instagram DM Link Button */}
      <a 
        href="https://ig.me/m/binary.bond_official" 
        target="_blank" 
        rel="noopener noreferrer"
        className="bg-brand-blue hover:bg-blue-700 text-white px-5 py-2 rounded-full text-xs font-bold tracking-wide transition-all duration-300 cursor-pointer no-underline shadow-md shadow-blue-500/20"
      >
        Build Your Vision
      </a>
    </nav>
