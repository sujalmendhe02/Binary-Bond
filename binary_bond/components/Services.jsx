...
export default function Services() {
  ...
  const services = [
    {
      ...
      shortDesc:
        "Beautiful responsive interfaces using React.jsx and Tailwind.",
      fullDesc:
        "We specialize in building high-conversion landing pages and complex web dashboards. Our front-end stack ensures your site is lightning fast and works perfectly on every mobile device.",
      features: [
    ...
    },
    {
      ...
      shortDesc:
        "Robust server networks and optimized database designs.",
      fullDesc:
        "From database modeling to secure API integrations, we build the backbone of your business. We ensure your data is safe and your system can handle thousands of users simultaneously.",
      features: [
        "Node.js Backends",
        "Database Scaling",
        "API Security",
    ...
    },
    {
      ...
      shortDesc:
        "Strategic structures engineered to rank and retain users.",
      fullDesc:
        "Building a site is only half the battle. We optimize your technical SEO and content structure so that your target audience can actually find you on Google without paid ads.",
      features: [
        "Technical SEO",
        "Speed Optimization",
        "Keyword Strategy",
  ...
  return (
    <section
      id="services"
      className="py-24 bg-brand-blue px-6 lg:px-12 relative"
    >
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-black text-white mb-16 leading-tight">
          Expertise that <br />
          <span className="opacity-70">Scales Businesses</span>
        </h2>
